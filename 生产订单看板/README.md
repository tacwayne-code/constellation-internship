...
- 页面地址：`http://[INTERNAL_IP]:8090/`
- 健康检查：`http://[INTERNAL_IP]:8090/api/health`
- 数据接口：`http://[INTERNAL_IP]:8090/api/dashboard`
